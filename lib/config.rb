...
def set_global_vars_early
  ...
  ks = [:skip, :redraw, :done, :next, :back, :forget, :quit, :replay, :octave,
        ...
        :switch_modes,
        :journal_menu, :journal_current, :journal_play, :journal_delete, :journal_clear, :journal_write, :journal_edit, :journal_all_toggle, :journal_with_timing, :change_display, :change_comment, :update_comment, :toggle_progress,
        :set_ref]
