...
** Overview of 'harpwise tools'
  ...
  it can be one of:
    ...
    - keys:
      ...
      chart.  The first argument is the key of the harp, the second the
      key of the song; use '.' to skip emphasising the harp.
      
      As the song positions are a fifth apart from each other, you
