...
** Overview of 'harpwise tools'
  ...
  it can be one of:
    ...
    - match-harps:
      ...
      of all known keys, checking if the holes can be played; this tool
      regards either all holes or the hole sets draw_full and blow_full.
      It answers the question (e.g.): Can a series of notes be played
      on any harmonica? Can it be played without bends?
