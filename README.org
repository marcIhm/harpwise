...
* harpwise - an introduction
  ...
  The image below links to a screencast, showing how harpwise (mode
  'listen') reacts on notes played. No sound has been recorded, so some
  accustic imagination is required.
  
  [[https://asciinema.org/a/670611][https://asciinema.org/a/670611.svg]]
  
  The second screencast is from mode 'quiz', showing three of the many
  flavours.
  
  [[https://asciinema.org/a/670612][https://asciinema.org/a/670612.svg]]
