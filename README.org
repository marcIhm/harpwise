...
* harpwise - an introduction
  ...
  harpwise supports the practice of scales, licks, bends, warbles,
  ...
  The second screenshot is from mode 'quiz', flavour 'recall': The program
  has played five notes initially and now challenges to play them back.
...
* Getting started
  ...
  - quiz: train your ear and musical knowledge with eight flavours
...
* Getting help
  ...
  - The program harpwise will issue a usage information, if invoked wrong
    or with too few arguments. This usage screens contain lots of
    examples and descriptions for invoking harpwise and for the form of
