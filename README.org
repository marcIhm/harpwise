...
* harpwise
  ...
  Ruby script to support the daily practice of bends, scales, intervals or
  licks on a diatonic (richter) or chromatic harmonica for various keys.

  Please note, that harpwise is limited to play and recognize single notes
  only; it has no sense of chords or grooves. So among the three
  ingredients of music, i.e. melody, harmony and rhythm, it can only help
  you with melody and (to some extent) harmony.
...
* Usage and Overview
  ...
  - tools: Some utilities, mostly related to basic harmonica theory
  ...
  this file is created on first invocation and filled with only a three
